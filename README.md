...
```
go get -u github.com/earthengineering/grpc-gateway
```

# Usage

1. Make sure your EARTH grpc serivice has been started on `localhost:50051`
...
cd $GOPATH/src/github.com/earthengineering/grpc-gateway
```
